...
export const TitleVerify = () => {
  ...
  return (
    <>
      ...
      <p className="font-body xl:text-[18px] lg:text-[16px] text-[14px] leading-[1.75] font-normal text-[#39557E]">
        The code has been sent to your email address. Click the link below to go
        to your inbox:{" "}
        <a
