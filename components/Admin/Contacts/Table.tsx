...
import { deleteAllContact, getContacts } from "@/api/admin/contact/contact";

export const Table = () => {
  const { data: contacts, mutate, isError } = getContacts();
  ...
  useEffect(
    ...
    [currentPage, itemsPerPage, contacts.length]
  );
  ...
  const itemsToDisplay = contacts.slice(
  ...
  return (
    <div className="w-full">
      ...
      <div className="border rounded-lg overflow-hidden shadow">
        <TableTemplate head={["Name", "Email", "Title", "Seen", "Details"]}>
          <TBody contacts={itemsToDisplay} />
        </TableTemplate>
        <Pagination
          pageCount={pageCount}
